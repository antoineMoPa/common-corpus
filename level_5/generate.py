...
SYSTEM_PROMPT = (
    ...
    "All JSON must be valid. Use realistic, varied values (real names, cities, plausible numbers, "
    "real-looking filenames, etc). Never add commentary before or after the examples."
)
